...
package com.stoianovici.horatiu.kontrol.utils;
...
public class BluetoothService {
    ...
    /**
     * Returns the singleton intance of the bluetooth service
     * @param context
     * @param handler - a handler that is not null will replace the current handler in the instance
     * @return
     */
